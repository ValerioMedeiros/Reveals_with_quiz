    ...
    $.slickQuiz = function(element, options) {
        ...
        var plugin   = this,
            ...
            defaults = {
                ...
                nextSlideText: 'Continuar apresentação',
                questionCountText: 'Questão %current de %total',
                preventUnansweredText: 'Você deve selecionar no mínimo uma resposta.',
                ...
                animationCallbacks: { // only for the methods that have jQuery animations offering callback
                    ...
                    checkAnswer: function () { Reveal.layout(); },
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    ...
                    $quizResultsCopy.append('<p><a class="button ' + nextSlideClass + '" href="#">' + plugin.config.nextSlideText + '</a></p>');
                }
